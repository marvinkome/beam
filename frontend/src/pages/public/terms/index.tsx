...
export function Terms() {
    useLayoutEffect(() => {
        document.title = "Terms and Condition - Beam"
    }, [])
    return (
        <div className="terms">
            <Navbar />
            ...
            <div className="text-container">
                <div className="text-box">
                    ...
                    <p>
                        <strong>Last updated 5th August 2020</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <strong>you</strong>), and <strong>Beam</strong>
                        ,&nbsp;located at&nbsp;
                        <strong>3 Ayinke street,&nbsp;Yaba, Lagos&nbsp;100001 Nigeria</strong>
                        &nbsp;(<strong>we</strong>, <strong>us</strong>), concerning your access to
                        and use of the{" "}
                        <strong>
                            Beam (<a href="http://usebeam.chat">http://usebeam.chat</a>)
                        </strong>
                        &nbsp;website as well as any related applications (the <strong>Site</strong>
                        ).
                    </p>
                    <p>
                        The Site provides the following services: An online platform where you can
                        chat with others who share your interests. You agree that by accessing the
                    ...
                    <p>
                        ...
                        any supplemental terms and condition or documents that may be posted on the
                    ...
                    <p>
                        ...
                        updated &ldquo;Revised&rdquo; date and the updated version will be effective
                        as soon as it is accessible. You are responsible for reviewing these Terms
                    ...
                    <p>
                        1.5&nbsp;Our site is directed to people residing in the United States of
                        America. The information provided on the Site is not intended for
                    ...
                    <p>
                        1.6&nbsp;The Site is intended for users who are at least 13 years
                        old.&nbsp;If you are under the age of 13, you are not permitted to register
                    ...
                    <p>
                        <strong>●</strong>&nbsp;Our Privacy Notice{" "}
                        <a href="https://usebeam.chat/privacy-policy">here</a>, which sets out the
                    ...
                    <p>
                        <strong>●</strong>&nbsp;Our Acceptable Use Policy{" "}
                        <a href="https://usebeam.chat/acceptable-use">
                            https://usebeam.chat/acceptable-use
                        </a>
                    ...
                    <p>
                        ...
                        for which we make the site and our services available. The Site may not be
                    ...
                    <p>
                        <strong>●</strong>&nbsp;Systematically retrieve data or other content from
                        the Site to a compile database or directory without written permission from
                        us
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Make any unauthorized use of the Site, including
                        collecting usernames and/or email addresses of users to send unsolicited
                        email or creating user accounts under false pretenses
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Use the Site to advertise or sell goods and services
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Circumvent, disable, or otherwise interfere with
                    ...
                    <p>
                        <strong>●</strong>&nbsp;Engage in unauthorized framing of or linking to the
                        Site
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Trick, defraud, or mislead us and other users,
                        especially in any attempt to learn sensitive account information such as
                        user passwords
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Make improper use of our support services, or submit
                        false reports of abuse or misconduct
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Engage in any automated use of the system, such as
                        using scripts to send comments or messages, or using any data mining,
                        robots, or similar data gathering and extraction tools
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Interfere with, disrupt, or create an undue burden
                        on the Site or the networks and services connected to the Site
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Attempt to impersonate another user or person, or
                        use the username of another user
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Sell or otherwise transfer your profile
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Use any information obtained from the Site in order
                        to harass, abuse, or harm another person
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Use the Site or our content as part of any effort to
                        compete with us or to create a revenue-generating endeavor or commercial
                        enterprise
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Decipher, decompile, disassemble, or reverse
                        engineer any of the software comprising or in any way making up a part of
                        the Site
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Attempt to access any portions of the Site that you
                        are restricted from accessing
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Harass, annoy, intimidate, or threaten any of our
                        employees, agents, or other users
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Delete the copyright or other proprietary rights
                        notice from any of the content
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Copy or adapt the Site&rsquo;s software, including
                        but not limited to Flash, PHP, HTML, JavaScript, or other code
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Upload or transmit (or attempt to upload or to
                        transmit) viruses, Trojan horses, or other material that interferes with any
                        party&rsquo;s uninterrupted use and enjoyment of the Site, or any material
                        that acts as a passive or active information collection or transmission
                        mechanism
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Use, launch, or engage in any automated use of the
                    ...
                    <p>
                        <strong>●</strong>&nbsp;Disparage, tarnish, or otherwise harm, in our
                        opinion, us and/or the Site
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Use the Site in a manner inconsistent with any
                        applicable laws or regulations
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Threaten users with negative feedback or offering
                        services solely to give positive feedback to users
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Misrepresent experience, skills, or information
                        about a User
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Advertise products or services not intended by us
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;Falsely imply a relationship with us or another
                    ...
                    <p>
                        (a) all registration information you submit will be true, accurate, current,
                        and complete and relate to you and not a third party; (b) you will maintain
                    ...
                    <p>
                        ...
                        you must promptly notify us at team@usebeam.chat.
                    </p>
                    <p>
                        ...
                        remove or change a user name you select if we determine that such user name
                        is inappropriate.
                    </p>
                    <p>
                        ...
                        such account, a <strong>Third Party Account</strong>) by either:
                    </p>
                    <p>
                        (a) providing your Third Party Account login information through the Site;
                        or (b) allowing us to access your Third Party Account, as is permitted under
                    ...
                    <p>
                        ...
                        any fees or making us subject to any usage limitations imposed by such third
                        party service providers.
                    </p>
                    <p>
                        3.4&nbsp;By granting us access to any Third Party Accounts, you understand
                        that (a) we may access, make available and store (if applicable) any content
                        that you have provided to and stored in your Third Party Account (the
                        &ldquo;
                        <strong>Social Network Content</strong>&rdquo;) so that it is available on
                        and through the Site via your account, including without limitation any
                        friend lists;&nbsp;and (b) we may submit and receive additional information
                        to your Third Party Account to the extent you are notified when you link
                    ...
                    <p>
                        ...
                        informing you of those contacts who have also registered to use the Site. At
                        your email request to team@usebeam.chat or through your account settings (if
                    ...
                    <p>
                        <strong>4.</strong>&nbsp;&nbsp;**&nbsp;Content you provide to us**
                    </p>
                    <p>
                        ...
                        agree that your User Content may be viewed by other users on the Site, and
                    ...
                    <p>
                        ...
                        Use Policy, and you will be liable to us and indemnify us for any breach of
                    ...
                    <p>
                        ...
                        if, in our opinion, such User Content does not comply with the Acceptable
                        Use Policy.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        please contact us at team@usebeam.chat.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        of the Site, Services or Our Content may be copied, reproduced, aggregated,
                    ...
                    <p>
                        ...
                        any networks, servers or computer systems connected to the Site; and/or (b)
                    ...
                    <p>
                        ...
                        express or implied, that Our Content on the Site is accurate, complete or up
                        to date.
                    </p>
                    <p>
                        <strong>6.</strong>&nbsp;&nbsp;&nbsp;**&nbsp;Site Management**
                    </p>
                    <p>
                        6.1&nbsp;We reserve the right at our sole discretion, to (1) monitor the
                        Site for breaches of these Terms and Conditions; (2) take appropriate legal
                    ...
                    <p>
                        <strong>7.</strong>&nbsp;&nbsp;**&nbsp;Modifications to and availability of
                        the Site**
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        or Services during any downtime or discontinuance of the Site or Services.We
                        are not obliged to maintain and support the Site or Services or to supply
                    ...
                    <p>
                        <strong>8.</strong>&nbsp;&nbsp;**&nbsp;Disclaimer/Limitation of Liability**
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        of the Site&rsquo;s content and are not liable for any (1) errors or
                        ...
                        on our server; (3) any interruption or cessation of transmission to or from
                        the site or services; and/or (4) any bugs, viruses, trojan horses, or the
                    ...
                    <p>
                        <strong>●</strong>&nbsp;We do not exclude or limit in any way our liability
                    ...
                    <p>
                        <strong>●</strong>&nbsp;If we fail to comply with these Terms and
                        ...
                        not be responsible for any loss or damage that were not foreseeable at the
                    ...
                    <p>
                        ...
                        be limited to a total aggregate amount equal to the greater of (a) the sum
                        of &pound;5000 or (b) the amount paid, if any, by you to us for the
                    ...
                    <p>
                        <strong>●</strong>&nbsp;Please note that we only provide our Site for
                    ...
                    <p>
                        <strong>●</strong>&nbsp;If defective digital content that we have supplied,
                        damages a device or digital content belonging to you and this is caused by
                        our failure to use reasonable care and skill, we will either repair the
                        damage or pay you compensation.
                    </p>
                    <p>
                        <strong>●</strong>&nbsp;You have legal rights in relation to goods that are
                    ...
                    <p>
                        ...
                        account settings, if available, or by contacting us at team@usebeam.chat.
                    </p>
                    <p>
                        ...
                        contained in these Terms andConditions or of any applicable law or
                        regulation.
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>10.</strong>&nbsp;&nbsp;**&nbsp;Mobile Application**
                    </p>
                    <p>
                        10.1&nbsp;If you access the Services via a mobile application, then we grant
                    ...
                    <p>
                        10.2&nbsp;
                        <em>
                            <strong>For consumers only</strong> - If you are a customer in the
                            European Union, you have certain rights to decompile the Software if:
                        </em>
                    </p>
                    <p>
                        <em>
                            <strong>●</strong>&nbsp;this is necessary to obtain the information that
                            you need to make the software interoperable with other software and{" "}
                            <strong>●</strong>&nbsp;we have not made that information available to
                            you.
                        </em>
                    </p>
                    <p>
                        <em>
                            Before reverse engineering or decompiling the software, you must first
                            write to us and ask us to provide you with the interoperability
                            information that you need. Please provide us with full details of your
                            requirement so that we can assess what information you need. We may
                            impose reasonable conditions on providing you with interoperability
                            information. You must use that information only for the purpose of
                            making the software interoperable with other software. You must not use
                    ...
                    <p>
                        (a) The licence granted to you for our mobile application is limited to a
                        non-transferable licence to use the application on a device that utilizes
                        the Apple iOS or Android operating system, as applicable, and in accordance
                        with the usage rules set forth in the applicable App Distributor terms of
                        service;
                    </p>
                    <p>
                        ...
                        Conditions or as otherwise required under applicable law. You acknowledge
                    ...
                    <p>
                        (d) You represent and warrant that (i) you are not located in a country that
                        is subject to a U.S. government embargo, or that has been designated by the
                        U.S. government as a &ldquo;terrorist supporting&rdquo; country; and (ii)
                    ...
                    <p>
                        ...
                        must not be in breach of their wireless data service agreement when using
                        the mobile application; and
                    </p>
                    <p>
                        (f) You acknowledge and agree that the App Distributors are third party
                        beneficiaries of these Terms and Conditions, and that each App Distributor
                        will have the right (and will be deemed to have accepted the right) to
                        enforce these Terms and Conditions against you as a third party beneficiary
                        thereof.
                    </p>
                    <p>
                        <strong>11.</strong>&nbsp;&nbsp;**&nbsp;General**
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        or failure to act caused by any cause beyond or reasonable control.
                    </p>
                    <p>
                        11.6&nbsp;If any provision or part of a provision of these Terms and
                        Conditions is unlawful, void or unenforceable, that provision or part of the
                    ...
                    <p>
                        11.8&nbsp;
                        <em>
                            <strong>For consumers only</strong>&nbsp;&nbsp;- Please note that these
                            Terms and Conditions, their subject matter and their formation, are
                            governed by English law. You and we both agree that the courts of
                            England and Wales will have exclusive jurisdiction expect that if you
                    ...
                    <p>
                        11.9 Except as stated under the Mobile Application section, a&nbsp;person
                        who is not a party to these Terms and Conditions shall have no rightunder
                        the Contracts (Rights of Third Parties) Act 1999 to enforce any term of
                        these Terms and Conditions.
                    </p>
                    <p>
                        11.10&nbsp;In order to resolve a complaint regarding the Services or to
                        receive further information regarding use of the Services, please contact us
                        by email at team@usebeam.chat or by post to:
                    </p>
                    <p>Beam</p>
                    <p>3 Ayinke street</p>
                    <p>Yaba, Lagos 100001</p>
                    <p>Nigeria</p>
                </div>
            </div>
