...
export function PrivacyPolicy() {
    useLayoutEffect(() => {
        document.title = "Privacy Policy - Beam"
    }, [])
    return (
        <div className="privacy-policy">
            ...
            <div className="text-container">
                <div className="text-box">
                    ...
                    <p>
                        Thank you for choosing to be part of our community at Beam (&ldquo;
                        <strong>we</strong>&rdquo;, &ldquo;<strong>us</strong>&rdquo;, or &ldquo;
                        <strong>our</strong>&rdquo;). We are committed to protecting your personal
                        ...
                        information, please contact us at team@usebeam.chat.
                    </p>
                    <p>
                        When you visit our website{" "}
                        <a href="https://usebeam.chat">https://usebeam.chat</a> (the "
                        <strong>Website</strong>"), use our mobile application, as the case may be
                        (the "<strong>App</strong>") and more generally, use any of our services
                        (the "<strong>Services</strong>", which include the Website and App), we
                        appreciate that you are trusting us with your personal information. We take
                        your privacy very seriously. In this privacy notice, we seek to explain to
                    ...
                    <p>
                        ...
                        Services (which, as described above, includes our Website and App), as well
                    ...
                    <p>
                        <em>
                            <strong>In Short:</strong>&nbsp;We collect information that you provide
                            to us.
                        </em>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        country, location, information about who and when you use our Services and
                    ...
                    <ul>
                        ...
                        <li>
                            <em>Location Data.</em> We collect information data such as information
                            about your device's location, which can be either precise or imprecise.
                            How much information we collect depends on the type of settings of the
                            ...
                            information or by disabling your Locations settings on your device. Note
                    ...
                    <ul>
                        <li>
                            <em>Geo-Location Information.</em> We may request access or permission
                        ...
                        <li>
                            ...
                            platform, the type of mobile device you use, your mobile device's unique
                        ...
                        <li>
                            ...
                            notifications regarding your account or certain features of the App. If
                            you wish to opt-out from receiving these types of communications, you
                            may turn them off in your device's settings.
                        </li>
                    </ul>
                    <p>
                        The information is primarily needed to maintain the security and operation
                        of our App, for troubleshooting and for our internal analytics and reporting
                        purposes.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        affiliate programs, data providers, social media platforms, as well as from
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                our Services that may contain personal information. Prior to posting
                                a testimonial, we will obtain your consent to use your name and the
                                consent of the testimonial. If you wish to update, or delete your
                                testimonial, please contact us at lenny@usebeam.chat and be sure to
                        ...
                        <li>
                            <p>
                                ...
                                service and new feature information and/or information about changes
                        ...
                        <li>
                            <p>
                                ...
                                products, marketing and your experience.&nbsp;We may use and store
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            into a contract with you, we may process your personal information to
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            third parties to use tracking technology on the Services, which will
                            enable them to collect data on our behalf about how you interact with
                            our Services over time. This information may be used to, among other
                    ...
                    <p>
                        ...
                        parties. We have categorized each party so that you may easily understand
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                <strong>User Account Registration and Authentication</strong> and
                            </p>
                            <p>Facebook Login</p>
                    ...
                    <p>
                        ...
                        receive may vary depending on the social media provider concerned, but will
                        often include your name, email address, friends list, profile picture as
                    ...
                    <p>
                        ...
                        you on the relevant Services. Please note that we do not control, and are
                        ...
                        information, and how you can set your privacy preferences on their sites and
                        apps.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        &ndash; however, we may still communicate with you, for example to send you
                        ...
                        purposes. To otherwise opt-out, you may: contact us at team@usebeam.chat.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        include a Do-Not-Track (&ldquo;DNT&rdquo;) feature or setting you can
                        ...
                        or any other mechanism that automatically communicates your choice not to be
                    ...
                    <p>
                        ...
                        registered account with a Service, you have the right to request removal of
                        unwanted data that you publicly post on the Services. To request the removal
                    ...
                    <p>
                        ...
                        outside the State of California for a temporary or transitory purpose. All
                    ...
                    <p>
                        ...
                        in instances where you interact with us in-person, online, or by phone or
                    ...
                    <p>
                        You may contact us by email at team@usebeam.chat, or by referring to the
                    ...
                    <p>
                        Beam has disclosed the following categories or personal information to third
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            data, and interactions with our and other website, applications, systems
                            and advertisements.
                        </li>
                    ...
                    <p>
                        ...
                        information so that we can match it with the information you have previously
                    ...
                    <p>
                        To exercise these rights, you can contact us by email at team@usebeam.chat,
                    ...
                    <p>
                        ...
                        version will be indicated by an updated &ldquo;Revised&rdquo; date and the
                    ...
                    <p>
                        ...
                        Data Protection Officer (DPO),&nbsp;Lenny Johnson, by email at
                        lenny@usebeam.chat,&nbsp;by phone at +2348138538619, or by post to:
                    </p>
                    <p>Beam</p>
                    <p>Lenny Johnson</p>
                    <p>3 Ayinke street</p>
                    ...
                    <p>
                        ...
                        team@usebeam.chat. We will respond to your request within 30 days.
                    </p>
                </div>
            </div>
